...
public class ObjectFactory {
    ...
    private final static QName _AddResponse_QNAME = new QName("http://neededfiles/", "addResponse");
    private final static QName _GetData_QNAME = new QName("http://neededfiles/", "getData");
    private final static QName _GetDataResponse_QNAME = new QName("http://neededfiles/", "getDataResponse");
    private final static QName _Add_QNAME = new QName("http://neededfiles/", "add");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://neededfiles/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://neededfiles/", name = "getData")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://neededfiles/", name = "getDataResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://neededfiles/", name = "add")
